...
router.get('/user/:id', enterpriseController_1.getEmpresa);
router.put('/user/:id', enterpriseController_1.updateEmpresa);
router.delete('/user/:id', enterpriseController_1.deleteEmpresa);
